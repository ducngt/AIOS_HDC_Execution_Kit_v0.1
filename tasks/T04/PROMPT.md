...
Xây Administration Plane riêng với Human+AI, Domain/Capability/Semantic/Data/Agent/Integration registries; không coi admin là superuser.
...
3. Chỉ sau G1/G2 mới tạo branch `change/t04-<slug>` và Change Package.
...
- /admin tách khỏi leadership experience
- Admin roles tách biệt
- Có registry CRUD qua contract
- Admin AI đề xuất thay đổi nhưng không tự tạo institutional authority
