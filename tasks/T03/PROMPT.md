...
Xây Workspace Composer, dashboard theo công việc thuộc thẩm quyền, widget contract, catalog động theo role/context/authority.
...
3. Chỉ sau G1/G2 mới tạo branch `change/t03-<slug>` và Change Package.
...
- Workspace sinh từ manifest
- Dashboard ưu tiên work/progress/risk/decision trong authority scope
- Hai PHT có portfolio khác nhau cho dashboard khác nhau
- Tile domain tự sinh từ registry
